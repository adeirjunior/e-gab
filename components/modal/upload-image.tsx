...
export default function UploadImageModal({website, images}: {website: Website, images: SearchResult[]}) {
        ...
        <ModalContent>
          {(onClose) => (
            <>
              ...
              <ModalBody>
                <GalleryGrid websiteCloudinaryDir={website.cloudinaryDir} images={images} />
              </ModalBody>
              <ModalFooter>
