  ...
  return (
    <footer className="br-footer">
      <div className="container-lg">
        ...
        >
          <div className="col-2">
            <Link className="br-item header" href="#">
            ...
            <div className="br-list">
              ...
              <Link className="br-item" href="#">
                <div className="content">Adipisicing culpa et ad consequat</div>
              </Link>
              <Link className="br-item" href="#">
                <div className="content">Qui esse</div>
              </Link>
              <span className="br-divider d-md-none"></span>
            </div>
          </div>
      ...
      <div className="container-lg">
        <div className="info">
          <div className="text-down-01 pb-3 text-medium">
