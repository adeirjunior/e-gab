    ...
    <div className="flex min-h-screen flex-col justify-center bg-white py-6 sm:py-12">
      <div className="w-full px-2 py-3 sm:mx-auto sm:max-w-xl sm:px-0">
        <div className="relative text-sm font-semibold text-gray-700 antialiased">
          ...
          <TimelineBlockLeft
            text="Crie a sua conta como um político."
            Icon={Icon2}
          />

          <TimelineBlockRight
            text="Faça as configurações inicias."
            Icon={Icon1}
          />

          <TimelineBlockLeft
            text="Convide outros usuários para administrarem o conteúdo do seu site."
            Icon={Icon2}
          />

          <TimelineBlockRight
            text="Nunca mais fique desconectado do seu eleitorado!"
            Icon={Icon1}
          />
        </div>
      </div>
