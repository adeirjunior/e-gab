...
export default function ProposalSection({ proposal }: { proposal: Proposal }) {
  return (
    <div className="text-center mx-auto px-6 max-w-4xl lg:flex lg:flex-row lg:items-center lg:text-start gap-6 lg:justify-start text-primary-800">
      <span className="min-w-60 w-fit"><Icon name={proposal.type} /></span> 
